...
class Halamansiswa extends CI_Controller {
	...
	public function index(){
           ...
           $data["links"] = explode('&nbsp;',$str_links );
    		   ...
    		   $data['deadline'] = $this->Mklien->DeadLine();
	...
	public function ajukan(){
      ...
      $data['rek'] = $this->Madmin->GetSet();
	    $data['detail'] = $this->Mmahasiswa->GetMahasiswa(" where nrp=$nrp");
      $data['jum'] = $this->Mmahasiswa->Gj(" where username=$nrp");
      $data['judul'] = $this->Mmahasiswa->GetJudul(" where j.username=m.nrp and j.username=$nrp");
      $data['deadline'] = $this->Mklien->DeadLine();
      $data['jdp'] = $this->Mmahasiswa->GetJudul(" where j.username=m.nrp and j.username=$nrp and j.status='Diambil'");  
  ...
  public function rekomendasi(){              
      ...
      $data['detail'] = $this->Mmahasiswa->GetMahasiswa(" where nrp=$nrp");
      $data['jum'] = $this->Mmahasiswa->Gj(" where username=$nrp");
      $data['judul'] = $this->Mmahasiswa->GetJudul(" where j.username=m.nrp and status='Disetujui'");
      $data['deadline'] = $this->Mklien->DeadLine();
      $data['jdp'] = $this->Mmahasiswa->GetJudul(" where j.username=m.nrp and j.username=$nrp and j.status='Diambil'");  
       $this->load->view('mahasiswa/rekomendasi',array('data'=>$data));
  }
  ...
  public function saran(){              
      ...
      $data['deadline'] = $this->Mklien->DeadLine();
      $data['jdp'] = $this->Mmahasiswa->GetJudul(" where j.username=m.nrp and j.username=$nrp and j.status='Diambil'");  
       $this->load->view('mahasiswa/saran',array('data'=>$data));
  }
  ...
  public function taku(){
      ...
      $data['rek'] = $this->Madmin->GetSet();
      $data['detail'] = $this->Mmahasiswa->GetMahasiswa(" where nrp=$nrp");
      $data['judul'] = $this->Mmahasiswa->GetJudul(" where j.username=m.nrp and j.username=$nrp and j.status='Diambil'");
      $data['deadline'] = $this->Mklien->DeadLine();
      $data['jdp'] = $this->Mmahasiswa->GetJudul(" where j.username=m.nrp and j.username=$nrp and j.status='Diambil'");  
       $this->load->view('mahasiswa/taku',array('data'=>$data));
  }
  public function ta(){
      $width = '100%';
      $height = '100px';
      ...
      $data['deadline'] = $this->Mklien->DeadLine();
      $data['jdp'] = $this->Mmahasiswa->GetJudul(" where j.username=m.nrp and j.username=$nrp and j.status='Diambil'");  
       $this->load->view('mahasiswa/ta',array('data'=>$data));
  }
	...
	public function ajukanjudul(){
 	...
 	public function dosen(){                  
           ...
           //$data = array();
            //ambil data buku dari database
           $data['dosen'] = $this->Mklien->GetDosen($config['per_page'],$dari);
           $data['username'] = $this->session->userdata('username');
    		   $nrp = $this->session->userdata('username');
    		   $data['deadline'] = $this->Mklien->DeadLine();
    		   $data['detail'] = $this->Mmahasiswa->GetMahasiswa(" where nrp=$nrp");          
	...
	public function hapusajuan($idjudul){				
		...
		$where = array('idjudul' => $idjudul);
 		$res = $this->Mklien->HapusJudul('judul',$where); 		
		redirect('halamansiswa/ajukan');	 				 
	 }
  ...
  public function diambil($idjudul){
    ...
    redirect('halamansiswa/rekomendasi');  
  }
  public function bimbinganta(){
      ...
      $data['detail'] = $this->Mmahasiswa->GetMahasiswa(" where nrp=$nrp");
      $data['jdp'] = $this->Mmahasiswa->GetJudul(" where j.username=m.nrp and j.username=$nrp and j.status='Diambil'");
      $data['bimbingan'] = $this->Mmahasiswa->GetBimbingan(" where d.nip=b.nip and b.idjudul='$idjd' and status='TA' order by b.tgl_bimbingan");
      $data['bimbing'] = $this->Mmahasiswa->GetBimbinganLimit(" where nrp='$nrp' and status='TA'");
      $data['deadline'] = $this->Mklien->DeadLine();
      $this->load->view('mahasiswa/bimbinganta',array('data'=>$data));
  }
  ...
  public function bimbinganku(){
      ...
      $data['detail'] = $this->Mmahasiswa->GetMahasiswa(" where nrp=$nrp");
      $data['jdp'] = $this->Mmahasiswa->GetJudul(" where j.username=m.nrp and j.username=$nrp and j.status='Diambil'");
      $data['bimbingan'] = $this->Mmahasiswa->GetBimbingan(" where d.nip=b.nip and b.idjudul='$idjd' and status='Proposal' order by b.tgl_bimbingan");
      $data['bimbing'] = $this->Mmahasiswa->GetBimbinganLimit(" where nrp='$nrp' and status='Proposal'");
      $data['deadline'] = $this->Mklien->DeadLine();
  ...
  public function ambilsaran(){
      ...
      $data['detail'] = $this->Mmahasiswa->GetMahasiswa(" where nrp=$nrp");
      $data['dosen'] = $this->Mmahasiswa->GetDosen();
      $data['judul'] = $this->Mjudul->Jud(" where idjudul=$idj");
      $data['jdp'] = $this->Mmahasiswa->GetJudul(" where j.username=m.nrp and j.username=$nrp and j.status='Diambil'");   
      $data['deadline'] = $this->Mklien->DeadLine();
      $this->load->view('mahasiswa/ambilsaran',array('data'=>$data));
  }

  public function ambil($idjudul){
    $this->load->library('upload');
        $nmfile = "file_".time();
        $config['upload_path'] = './assets/dokumen/';
        $config['allowed_types'] = 'pdf';
