          ...
          <div class="col-md-3">
            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <a href="<?php echo base_url()."index.php/Cdosen/monitoringti"?>" class="btn btn-warning btn-block btn-sm"><b>Back</b></a>
              </div>
              <!-- /.card-body -->
            </div>
                  ...
                  <table id="example2" class="table table-bordered table-striped">
                    ...
                    <td align="center">
                      <?php 
                              ...
                              if($ada == 'Belum'){
                              ?>
                              <a href="<?php echo base_url()."index.php/Cdosen/accti?idb=".$d['idb']."&idjudul=".$d['idjudul']; ?>"><span class="label label-primary">Konfirmasi</span></a>
                              <?php   
                              }else{  ?>
