...
?>
 ...
 <div class="col-md-12">                                    
		...
		<div class="card-header">
                <h5 class="card-title">Data Monitoring TI</h5>
			...
			?>
				...
				<td>
				<a href="<?php echo base_url()."index.php/Cdosen/dti?idjudul=".$d['idjudul'] ?>">Lihat Monitoring</a>
				</td>								
