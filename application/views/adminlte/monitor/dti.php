          ...
          <div class="col-md-3">
            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <a href="<?php echo base_url()."index.php/home/monitoringti"?>" class="btn btn-warning btn-block btn-sm"><b>Back</b></a>
              </div>
              <!-- /.card-body -->
            </div>
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="active tab-pane" id="ti">
                    <!-- Post -->
                  <div class="post">
                  <form method="post" action="<?php echo base_url()."index.php/judul/accti"?>">
                    <input type="text" style="display: none;" name="idjudul" value="<?php echo $_GET['idjudul']; ?>">
                    <input type="text" style="display: none;" name="status" value="Proposal">
                  <button type="submit" class=" btn btn-block btn-success">Setujui Maju Sidang</button>
                  </form>
                  <table id="example2" class="table table-bordered table-striped">
                    ...
                    <td align="center">
                      <?php 
                              ...
                              if($ada == 'Belum'){
                              ?>
                              <a href="<?php echo base_url()."index.php/home/accti?idb=".$d['idb']."&idjudul=".$d['idjudul']; ?>"><span class="badge badge-primary">Konfirmasi</span></a>
                              <?php   
                              }else{  ?>
                ...
                <div class="tab-pane" id="mm">
                    ...
                    <form method="post" action="<?php echo base_url()."index.php/judul/accti"?>">
                      <input type="text" style="display: none;" name="idjudul" value="<?php echo $_GET['idjudul']; ?>">
                      <input type="text" style="display: none;" name="status" value="TA">
                      <button type="submit" class=" btn btn-block btn-success">Setujui Maju Sidang</button>
                    </form>
                    ...
                    <td align="center">
                      <?php 
                              ...
                              if($ada == 'Belum'){
                              ?>
                              <a href="<?php echo base_url()."index.php/home/accti?idb=".$d['idb']."&idjudul=".$d['idjudul']; ?>"><span class="label label-primary">Konfirmasi</span></a>
                              <?php   
                              }else{  ?>
