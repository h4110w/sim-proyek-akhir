            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="active tab-pane" id="ti">
                    <!-- Post -->
                  <div class="post">
                  <form method="post" action="<?php echo base_url()."index.php/judul/accmm"?>">
                  ...
                  <table id="example2" class="table table-bordered table-striped">
                    ...
                    <td align="center">
                      <?php 
                              ...
                              if($ada == 'Belum'){
                              ?>
                              <a href="<?php echo base_url()."index.php/home/accmm?idb=".$d['idb']."&idjudul=".$d['idjudul']; ?>"><span class="badge badge-primary">Konfirmasi</span></a>
                              <?php   
                              }else{  ?>
                ...
                <div class="tab-pane" id="mm">
                    ...
                    <td align="center">
                      <?php 
                              ...
                              if($ada == 'Belum'){
                              ?>
                              <a href="<?php echo base_url()."index.php/home/accmm?idb=".$d['idb']."&idjudul=".$d['idjudul']; ?>"><span class="label label-primary">Konfirmasi</span></a>
                              <?php   
                              }else{  ?>
