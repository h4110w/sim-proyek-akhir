		...
		<div class="card-header">
			...
			?>
				...
				<?php 
					$ada = $d['tanggal_acc'];
					$stts = $d['status'];										
					if($ada == null || $stts == 'Belum Diambil'){
					?>
					<a>Menunggu</a>
					<?php 	
					}else{	?>
					<a href="<?php echo base_url()."index.php/judul/batal?idjudul=".$d['idjudul']; ?>" type="button" class="btn btn-block btn-warning btn-sm">Batalkan</a>
				<?php
					}
				?>				
				  </td>					
...
$this->load->view('adminlte/crud/editsjudul');
?>
