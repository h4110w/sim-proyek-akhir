...
?>
<?php }else{ ?>
<a href="#"><h3 id="bimbingan">Form Bimbingan TA</h3></a>
<?php }}?>
<form enctype="multipart/form-data" id="formbimbingan" style="display: none;"  action="<?php echo base_url()."index.php/Cmonitoring/bimbingkanta"; ?>" method="post">
...
<tr>
<td><?php echo $no; ?></td>
<td>Bimbingan TA ke <?php echo $no; ?></td>
